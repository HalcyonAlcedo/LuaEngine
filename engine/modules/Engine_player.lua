...
--获取玩家武器Id和类型
local function getPlayerWeaponType()
    local Type = GetAddressData(engine_player.pointer.Weapon.Data + 0x2E8, 'int')
    return Type
end
local function getPlayerWeaponId()
    local Id = GetAddressData(engine_player.pointer.Weapon.Data + 0x2EC, 'int')
    return Id
end
