			...
			[](auto entity) {
				for (auto [ptr, addSpeed] : SpeedList) {
					if (entity == ptr) {
						...
						float now_speed = *(float*)((long long)*(long long*)(0x145121688) + (*(int*)((long long)entity + 0x10) * 0xf8) + 0xa0);
						if (now_speed + addSpeed >= 0) {
							*(float*)((long long)*(long long*)(0x145121688) + (*(int*)((long long)entity + 0x10) * 0xf8) + 0xa0) = now_speed + addSpeed;
							...
							*(float*)((long long)*(long long*)(0x145121688) + (*(int*)((long long)entity + 0x10) * 0xf8) + 0xa0) = 0;
